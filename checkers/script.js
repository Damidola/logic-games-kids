...
function showGameResult(winner) {
    ...
    const again = { onAgain: resetGame, delay: 700 };
    if (isPlayerWinner) LG.win('У робота не лишилося ходів. Чудова партія!', again);
    else LG.lose('У тебе не лишилося ходів. Натисни ↩️, щоб повернутися і спробувати інакше.', again);
